		...
		<div id="testimonialsSection" class="section">
			...
			<div id="testimonialsWrapper">
				<div id="testimonialsList">
					...
					<div class="testimonialFrame">
						<p class="testimonialText">My experience with Joseph was extremely positive. I got two offers within two days of being on the market, and I was willing to accept a number---in CASH--that I was comfortable with. I wanted expediency, but Joe told me to give him a few days and he'd get me a bit more. I agreed, and he did get me more.</br></br>After meeting with several real estate people, I knew immediately that Joe would handle my sale. Although he deploys modern day statistical analysis, he's  got an old school streak in him as well---he can read people, and understands what buyers and sellers want, need, and will accept. Like a good baseball manager, he uses a mix of new school Sabermetrics and time-honored people skills to get the desired result. And he SHOULD know what he's doing---he's been at it in RI forever. I would highly recommend him, and if I ever were to do any more RE transactions, he'd be my first choice.</p>
						<p class= "testimonialName">-Richard</p>
					</div>
					<div class='testimonialFrame'>
						<p class="testimonialText">I have spent many years in the business and it is a pleasure to meet and have the opportunity to work with someone like Joseph McCarthy and his Associates.   There are dozens of brokers out there, but the chance to work with a Broker with as much, experience, market knowledge and integrity as Joseph, is indeed rare.  Believe me when I say there are very few who will take the time, spend the energy, and care enough to not only meet your individual needs , but to offer solutions, and knowledge along the way. His expertise and help with financing options, with working with the Town , or even design ideas, is the best. August Associates should be considered not only a "Valued Guide " but an asset you do not want to be without in any Real Estate transaction.</p>
						<p class="testimonialName">-Susan Dufour Associate Broker</p>
					</div>
					<div class="testimonialFrame">

...
<html lang="en" dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	<head>
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-124172126-1"></script>
		<script>
			window.dataLayer = window.dataLayer || [];
			function gtag(){dataLayer.push(arguments);}
			gtag('js', new Date());
			gtag('config', 'UA-124172126-1');
			...
			})(window,document,'script','dataLayer','GTM-5VT6SN4');
		...
		<noscript>
			<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5VT6SN4"height="0" width="0" style="display:none;visibility:hidden"></iframe>
		</noscript>
